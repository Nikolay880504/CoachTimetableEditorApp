...
namespace CoachTimetableEditorApp.DataBase
{


    public class QuartzTableCreator
    {
        public void CreateQuartzTables(string connectionString)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                {
                    string sqlScript = @"CREATE TABLE QRTZ_JOB_DETAILS
  (
